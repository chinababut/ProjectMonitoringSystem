...
<div class="container"> 
 <div class="box"> 
  ...
  <div class="details"><h4>Chief Commissioner of Land Administration, jasti Towers,second floor,Sai Puram Colony Road,Gollapudi one centerVijayawada 521225</h4></div> 
 </div> 
 <div class="box"> 
  <div class="icon"><i class="fa fa-phone" aria-hidden="true"></i></div> 
  <div class="details"><h3>+91 123 456 7890</h3></div> 
 </div> 
 <div class="box"> 
  <div class="icon"><i class="fa fa-envelope" aria-hidden="true"></i></div> 
  <div class="details"><h3>cclarev@gmail.com</h3></div> 
 </div> 
</div>
